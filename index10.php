...
define("SIGN_UP_URL",  'Auth/index.php');
echo $serverName.GlobalConstants::SITE_CONTEXT.'/ABC';
define("SIGN_IN_URL", $serverName . GlobalConstants::SITE_CONTEXT . 'auth/login.php');
?>
<!doctype html>
<html lang="en">
<head>
...
<div class="container text-center mt-5">
    ...
    <!-- CALL TO ACTION -->
    <div class="mt-4">
        <a href=<?= SIGN_IN_URL ?> class="btn btn-primary btn-lg">Login</a>
        <a href=<?= SIGN_UP_URL ?> class="btn btn-secondary btn-lg">Sign Up</a>
    </div>
</div>
